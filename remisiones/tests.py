...
class RemisionTest(TestCase):
    ...
    def crear_remision(self, numero_de_remision='001-001-0001740'):
        ...
        destino = PuntoEntregaCliente.objects.create(cliente=cliente, referencia="Móvil 1", direccion="Avda. casi calle'i 123")
        return Remision.objects.create(numero_de_remision=numero_de_remision, destino=destino)
